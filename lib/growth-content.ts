...
export const GOOGLE_ADS = {
  ...
  campaigns: [
    ...
    },
    {
      ...
      // Reg Z §1026.24(d): stating a down-payment % (e.g. "3.5% down") is a triggering
      // term requiring APR + repayment-terms disclosures on a consumer ad. Kept qualitative.
      descriptions: ["Low-down-payment options for buyers. See what you qualify for in 2 minutes — no credit pull.", "Local, licensed, fast. Apply online and a specialist follows up the same day."],
    },
  ],
...
export const META_ADS = {
  ...
  angles: [
    ...
    // Reg Z §1026.24(d): "$0 down" / "3.5% down" are triggering terms on a consumer ad — kept qualitative.
    { hook: "Think you can't buy a home yet? Let's check.", primary: "Low-down-payment FHA and VA options, plus down payment assistance. See what you qualify for in 2 minutes — no credit pull. 🏡", headline: "Get Pre-Approved Today" },
...
export const SOCIAL = {
  ...
  posts: [
    ...
    // Reg Z §1026.24(d): keep the video script qualitative — no specific down-payment %/$0 as triggering terms.
    { hook: "3 ways to buy a home with almost nothing down 👇", script: "Fast cuts: 1) low-down-payment conventional & FHA 2) VA/USDA for eligible buyers 3) Down payment assistance. 'Which one is you? Comment below.'", caption: "You might be closer to owning than you think. FHA, VA, and assistance programs. Link in bio to check — no credit pull. #firsttimehomebuyer #fha #downpaymentassistance", hashtags: "#firsttimehomebuyer #fha #valoan #downpaymentassistance #homebuyingtips" },
