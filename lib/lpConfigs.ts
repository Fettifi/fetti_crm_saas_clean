...
export const LP_CONFIGS: Record<string, LpConfig> = {
  ...
  tv: {
    ...
    subhead: "Buying a home, lowering your payment, or grabbing an investment property? Fetti is a nonbank lender — we do the deals banks won't. No stress, no runaround.",
    ...
    statesNote: "DSCR & investment property loans available in all 50 states. (Owner-occupied home loans: FL, MI & CA.)",
  ...
  dscr: {
    ...
    subhead: "Buy or refinance 1–4 unit rentals on the property's cash flow. No W-2, no DTI, close in an LLC. We're a nonbank lender — we do the deals banks won't.",
  ...
  "dscr-refi": {
    ...
    bullets: ["💵 Cash-out to scale your portfolio", "⚡ Qualify on rental income — no tax returns", "🛡️ Nonbank lender — we do the deals banks won't"],
    occupancy: "Investor", productType: "Investment",
  ...
  refinance: {
    ...
    subhead: "Cut your monthly payment, shorten your term, or pull cash out. We're a nonbank lender that gets it done — and we do the refinances banks turn down.",
    bullets: ["💵 Lower payment, shorter term, or cash out", "⚡ Pre-qualify in 2 minutes — no credit pull to start", "🛡️ A nonbank lender in your corner — not a bank's quota"],
    occupancy: "Owner", productType: "Residential",
    ...
    markLine: "Lower your payment with a nonbank lender that gets it done. See it in 2 minutes. — Mark 🦉",
  },
  "cash-out-refi": {
    slug: "cash-out-refi",
    ...
    subhead: "Use the equity you've built for renovations, debt payoff, or your next investment. We're a nonbank lender — we get it funded and do the deals banks won't.",
    bullets: ["💵 Pull cash from your home's equity", "⚡ Pre-qualify in 2 minutes — no credit pull to start", "🛡️ A nonbank lender in your corner — not a bank's quota"],
    occupancy: "Owner", productType: "Residential",
  ...
  "fix-and-flip": {
    ...
    subhead: "Move quick on competitive deals — up to 100% financing of the whole deal (purchase + rehab) under the right circumstances. Interest-only during the project, fast closings, experienced and first-time flippers welcome.",
    bullets: ["⚡ Up to 100% of the deal — purchase + rehab (right project)", "🏢 Fast closings to win competitive offers", "🛡️ Interest-only during the project"],
    occupancy: "Investor", productType: "Investment",
    purposes: [{ value: "purchase", label: "Fix & flip purchase", loanPurpose: "Fix and Flip" }],
    markLine: "Fund the flip on the deal, not your DTI — up to 100% of purchase and rehab when it fits. Start your file. — Mark 🦉",
  },
  "bank-statement": {
    slug: "bank-statement",
