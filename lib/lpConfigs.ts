...
export const LP_CONFIGS: Record<string, LpConfig> = {
  ...
  refinance: {
    ...
    subhead: "Cut your monthly payment, shorten your term, or pull cash out. We're a nonbank lender that funds directly — and we do the refinances banks turn down.",
    ...
    markLine: "Lower your payment with a nonbank lender that funds it directly. See it in 2 minutes. — Mark 🦉",
  },
  "cash-out-refi": {
    slug: "cash-out-refi",
    ...
    subhead: "Use the equity you've built for renovations, debt payoff, or your next investment. We're a nonbank lender — we fund it directly and do the deals banks won't.",
