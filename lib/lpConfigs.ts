...
export const LP_CONFIGS: Record<string, LpConfig> = {
  ...
  dscr: {
    ...
    subhead: "Buy or refinance 1–4 unit rentals on the property's cash flow. No W-2, no DTI, close in an LLC. We're a nonbank lender — we fund it with our own capital and do the deals banks won't.",
  ...
  "dscr-refi": {
    ...
    bullets: ["💵 Cash-out to scale your portfolio", "⚡ Qualify on rental income — no tax returns", "🛡️ Nonbank lender — we fund it with our own capital"],
    occupancy: "Investor", productType: "Investment",
