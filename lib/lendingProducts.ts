// THE COPY FOR EVERY /lending PROGRAM PAGE.
//
// Lifted out of app/lending/[slug]/page.tsx so `npm run verify:seo` can import the real
// strings and MEASURE them — word count and pairwise similarity — instead of scraping the
// page source and hoping. A guard that reads a different text than the one that ships is not
// a guard. The page still owns the rendering; this file owns the words.
import { PRODUCT_SCOPE } from "@/lib/lendingMatrix";
