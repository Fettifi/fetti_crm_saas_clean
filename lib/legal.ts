...
export const LICENSING_NOTE =
  "Fetti Financial Services LLC · NMLS #2267023 · CA DFPI Financing Law License #60DBO-153798. A licensed mortgage lender and broker — owner-occupied residential mortgage loans in Florida, Michigan, and California. Investment and business-purpose loans (DSCR, fix & flip, bridge, hard money, and business loans) are available in all 50 states. Equal Housing Opportunity. This is an advertisement, not a commitment to lend; all loans are subject to credit approval and program guidelines.";

export const LICENSING_SHORT =
  "Mortgage lender & broker · NMLS #2267023 · CA #60DBO-153798. Owner-occupied mortgages: FL, MI & CA. Investment & business loans: all 50 states.";
