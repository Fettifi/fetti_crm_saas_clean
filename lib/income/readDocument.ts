...
3) EMPLOYER / STREAM: employerOrPayer (exact), ein (if shown). caseOrRecipient = any recipient name or case/account number that distinguishes this income source (IHSS recipient + case #, or a bank account last-4). streamId = a stable key combining employer + EIN + case/recipient (e.g. "CoreCivic|EIN62-..." or "IHSS|case#1837869"). incomeCategory: wage_salaried (steady base) | wage_variable (fluctuating hourly/gig/IHSS/tips) | self_employment (1099/Sch C) | fixed_benefit (SSA/pension/disability) | null.
