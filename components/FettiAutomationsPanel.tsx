...
type FettiSequencesData = {
  config: {
    ...
    sequences: {
      sms: SequenceMeta;
      email: SequenceMeta;
      voicemail: SequenceMeta;
    };
  };
  sms: { meta: SequenceMeta; text: string };
  email: { meta: SequenceMeta; text: string };
  voicemail: { meta: SequenceMeta; text: string };
};

export function FettiAutomationsPanel({ fetti }: { fetti: FettiSequencesData }) {
  return (
