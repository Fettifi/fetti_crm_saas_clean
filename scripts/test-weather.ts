...
const toolDefinitions = [
    {
        name: "deepResearch",
        description: "Search the web. Use this for ANY question about current events, weather, prices, news, facts, or research.",
        parameters: {
...
async function testWeather() {
    console.log("Testing Weather Query with gemini-2.0-flash...");
    try {
        ...
        if (call.name === 'deepResearch') {
            ...
            searchResults.forEach(r => console.log(`- ${r.title}: ${r.content.substring(0, 50)}...`));
