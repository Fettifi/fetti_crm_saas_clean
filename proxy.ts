...
export async function proxy(request: NextRequest) {
    ...
    const apiProtected = ['/api/los', '/api/income', '/api/stats', '/api/tasks', '/api/players', '/api/bosses', '/api/growth/generate', '/api/content', '/api/doctor', '/api/preapprovals', '/api/tiktok/publish', '/api/tiktok/creator-info', '/api/chat', '/api/rupee', '/api/pricing', '/api/funnel', '/api/partners', '/api/agents', '/api/applications', '/api/tts', '/api/studio', '/api/settings', '/api/esign/requests', '/api/dashboard', '/api/pricer', '/api/referral', '/api/voice/messages', '/api/scenarios', '/api/wholesalers', '/api/conversations', '/api/compare', '/api/show', '/api/admin', '/api/shield/resolve', '/api/competitors', '/api/realtors', '/api/underwrite', '/api/underwriter-desk', '/api/scout']
    ...
    const protectedRoutes = [
        ...
        '/command', '/los', '/agents', '/partners', '/requests', '/automations', '/task-list', '/roadmap', '/dashboard', '/growth', '/content', '/doctor', '/preapprovals', '/rupee', '/pricing', '/funnel', '/ads', '/security', '/studio', '/esign', '/pricer', '/income', '/messages', '/scenarios', '/conversations', '/compare', '/show', '/competitors', '/realtors', '/tiktok-today', '/underwrite', '/underwriter', '/scout',
    ]
