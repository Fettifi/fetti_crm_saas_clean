...
// NOINDEX FOR EVERY BORROWER-PRIVATE TOKEN ROUTE UNDER /letter.
//
...
//
// This is a LAYOUT, not a page, so it covers every nested route under /letter including any added later.
//
