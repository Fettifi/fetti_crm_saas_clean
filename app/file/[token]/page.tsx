    ...
    <div className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-2xl mx-auto px-4 py-10">
        <div className="flex items-center gap-2">
          ...
          <div className="text-emerald-400 font-extrabold text-lg">Fetti<span className="text-white"> Financial</span><sup className="text-[0.55em] align-top opacity-70">™</sup></div>
        </div>
