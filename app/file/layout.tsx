...
// NOINDEX FOR EVERY BORROWER-PRIVATE TOKEN ROUTE UNDER /file.
//
...
//
// This is a LAYOUT, not a page, so it covers every nested route under /file including any added later.
//
