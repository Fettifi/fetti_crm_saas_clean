...
// NOINDEX FOR EVERY BORROWER-PRIVATE TOKEN ROUTE UNDER /sign.
//
...
//
// This is a LAYOUT, not a page, so it covers every nested route under /sign including any added later.
//
