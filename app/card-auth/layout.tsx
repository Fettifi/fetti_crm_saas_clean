...
// NOINDEX FOR EVERY BORROWER-PRIVATE TOKEN ROUTE UNDER /card-auth.
//
...
//
// This is a LAYOUT, not a page, so it covers every nested route under /card-auth including any added later.
//
