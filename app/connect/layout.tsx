...
// NOINDEX FOR EVERY BORROWER-PRIVATE TOKEN ROUTE UNDER /connect.
//
...
//
// This is a LAYOUT, not a page, so it covers every nested route under /connect including any added later.
//
