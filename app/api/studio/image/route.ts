...
export async function POST(req: NextRequest) {
  try {
    ...
    const MASCOT = "Featuring Mark, the Fetti Financial Services brand mascot — an original GOLDEN OWL (gold/amber/honey-gold feathers, his signature color, with emerald/slate accents), smart stylish glasses, intelligent and dignified ('knighthood' poise) yet effortlessly cool with relaxed California body-swagger. Bold modern vector illustration, thick clean outlines, flat vibrant colors, scroll-stopping and memorable. Refined and aspirational, NOT street/ghetto. Original character — do NOT imitate the Simpsons, Family Guy, the GEICO gecko, or any existing show/brand.";
