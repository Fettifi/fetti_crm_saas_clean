...
- Fetti is a NONBANK lender that gets done the deals big banks won't, built for borrowers banks turn away (self-employed, investors, dinged credit, unusual income). We have the capital and capability to get it funded and closed — we get it done, start to finish. Keep the capital SOURCE open: never specify or promise whose capital funds a given loan (we may fund it directly or through a partner).
