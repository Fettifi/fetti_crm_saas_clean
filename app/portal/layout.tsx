...
// NOINDEX FOR EVERY BORROWER-PRIVATE TOKEN ROUTE UNDER /portal.
//
...
//
// This is a LAYOUT, not a page, so it covers every nested route under /portal including any added later.
//
